...
$(document).ready(function(){
    ...
    $("iframe.image_upload_form").load(function(){
      ...
      var new_image = $('<div class="image_block"><span class="image_id">'+data['id']+'</span><a href="/admin/imaging/image/'+data['id']+'/" class="edit_image">' + gettext("Edit") + '</a><a href="#" class="delete_image">' + gettext("Delete") + '</a><img src="'+data['image']+'" alt="'+data['alt']+'" /><span class="image_name">'+data['name']+'</span></div>');
